...
from .iag_multihead_attention import IAGMultiheadAttention
from .feature_encoders import SurfaceEncoder, CurveEncoder

class IAGEncoderLayer(nn.Module):
    def __init__(
        self,
