...
from .layers.iag_multihead_attention import IAGMultiheadAttention
from .layers.iag_encoder_layer import IAGEncoderLayer, GraphNodeFeature, IAGAttnBias
...
def init_params(module):
    ...
    if isinstance(module, IAGMultiheadAttention):
        normal_(module.q_proj.weight.data)
        normal_(module.k_proj.weight.data)
        normal_(module.v_proj.weight.data)


class IAGEncoder(nn.Module):
    def __init__(
            self,
            num_degree: int,
            num_spatial: int,
            ...
            q_noise: float = 0.0,
            qn_block_size: int = 8,
            used_inst_scale: bool = False,
            inst_init_std:float = 1.0,
    ) -> None:
        super().__init__()
        ...
        self.graph_attn_bias = IAGAttnBias(
        ...
        self.layers.extend(
            [
                self.build_graph_encoder_layer(
                    ...
                    used_inst_scale=used_inst_scale,
                    inst_init_std=inst_init_std,
                )
    ...
    def forward(
            ...
            inst_adj: Optional[torch.Tensor] = None,
